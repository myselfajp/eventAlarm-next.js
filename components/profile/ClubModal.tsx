                    ...
                    <div className="relative">
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-3 py-2.5 pl-10 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-colors"
                        />
                          ...
                          {isSearchingPresident ? (
                            ...
                            <>
                              <button
                                ...
                                className="w-full px-3 py-2 text-sm text-left hover:bg-gray-50 transition-colors text-gray-400"
                              >
                                None
                              </button>
                            ...
                            coachesResults.map(coach => (
                              <button
                                ...
                                className={`w-full px-3 py-2 text-sm text-left hover:bg-gray-50 transition-colors flex items-center gap-2 ${
                                  formData.coaches.includes(coach.coach._id) ? 'bg-cyan-50 text-cyan-700' : ''
                                }`}
                              >
                                <input
                                  type="checkbox"
                    ...
                    {formData.coaches.length > 0 && (
                      <div className="mt-2 flex flex-wrap gap-1">
                        {formData.coaches.map(coachId => (
                          <span
                            key={coachId}
                            className="inline-flex items-center gap-1 px-2 py-1 bg-cyan-100 text-cyan-700 text-xs rounded"
                          >
