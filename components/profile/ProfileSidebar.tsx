  ...
  return (
    <div className="h-full overflow-y-auto p-4 sm:p-6 flex flex-col">
      ...
      <div className="flex justify-around mb-6 sm:mb-8 text-center">
        <div>
          <div className="font-bold text-gray-800 dark:text-white text-sm sm:text-base">0</div>
          <div className="text-xs text-gray-500 dark:text-gray-400">Total Earnings</div>
        </div>
        <div>
          <div className="font-bold text-gray-800 dark:text-white text-sm sm:text-base">0</div>
          <div className="text-xs text-gray-500 dark:text-gray-400">New Referrals</div>
        </div>
        <div>
          <div className="font-bold text-gray-800 dark:text-white text-sm sm:text-base">0</div>
          <div className="text-xs text-gray-500 dark:text-gray-400">New Deals</div>
        </div>
      </div>
      ...
      <div className="space-y-2">
          ...
          <div className="flex items-center gap-2.5">
            <div
              className={`p-1.5 rounded-md ${
                hasParticipantProfile ? "bg-green-100 dark:bg-green-900/50" : "bg-blue-100 dark:bg-blue-900/50"
              }`}
            >
              <User
                className={`w-4 h-4 ${
                  hasParticipantProfile ? "text-green-600 dark:text-green-400" : "text-blue-600 dark:text-blue-400"
                }`}
              />
            </div>
            <div className="flex-1">
        ...
        >
          <div className="flex items-center gap-2.5">
            <div
              className={`p-1.5 rounded-md ${
                hasCoachProfile ? "bg-green-100 dark:bg-green-900/50" : "bg-orange-100 dark:bg-orange-900/50"
              }`}
            >
              <Users
                className={`w-4 h-4 ${
                  hasCoachProfile ? "text-green-600 dark:text-green-400" : "text-orange-600 dark:text-orange-400"
                }`}
              />
            </div>
            <div className="flex-1">
      ...
      <div className="space-y-2 pb-4">
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="font-medium text-gray-800 dark:text-white text-sm">My Clubs</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">
